...
const validationSchema = yup.object({
    ...
    passwordConfirm: yup.string()
        .min(6, "Un mot de passe d'au moins 6 caractères est attendu")
        .equals([yup.ref("password")], "La confirmation doit être similaire au mot de passe")
        .required("Un mot de passe est attendu")
});
        ...
        >
            ...
            <Box sx={{
                ...
                <Box component="form" noValidate onSubmit={handleSumbit} sx={{
                    ...
                    <TextField margin='normal' required fullWidth id="name" label="Nom" name='name' autoComplete='nom' autoFocus />
                    <TextField margin='normal' required fullWidth id="email" label="Adresse e-mail" name='email' autoComplete='email' />
                    <TextField margin='normal' required fullWidth id="password" type="password" label="Mot de passe" name='password'/>
                    <TextField margin='normal' required fullWidth id="passwordConfirm" type="password" label="Confirmation du mot de passe" name='passwordConfirm'/>
